...
define('SMTP_USERNAME',  getenv('AZURE_SMTP_USERNAME'));

// Password to use when authenticating with the SMTP server. Can be left blank for no auth.
define('SMTP_PASSWORD',  getenv('AZURE_SMTP_PASSWORD'));
